...
import { DIAGRAM_COLORS } from '../../../shared/constants/diagram-colors';
  ...
  static buildDataset(months: string[], volumeYAxis: string, percentageYAxis: string): ChartData<'bar' | 'line'> {
    return {
      ...
      datasets: [
        {
          data: [],
          borderColor: DIAGRAM_COLORS.CREDITOR_PERCENTAGES,
          backgroundColor: DIAGRAM_COLORS.CREDITOR_PERCENTAGES,
          fill: false,
          tension: 0,
        ...
        {
          data: [],
          borderColor: DIAGRAM_COLORS.CREDITOR_VOLUME,
          backgroundColor: DIAGRAM_COLORS.CREDITOR_VOLUME,
          yAxisID: volumeYAxis,
          type: 'bar',
          barThickness: 10,
          hidden: true,
        ...
        {
          data: [],
          borderColor: DIAGRAM_COLORS.DEBTOR_PERCENTAGES,
          backgroundColor: DIAGRAM_COLORS.DEBTOR_PERCENTAGES,
          fill: false,
          tension: 0,
          yAxisID: percentageYAxis,
          type: 'line',
        ...
        {
          data: [],
          borderColor: DIAGRAM_COLORS.DEBTOR_VOLUME,
          backgroundColor: DIAGRAM_COLORS.DEBTOR_VOLUME,
          yAxisID: volumeYAxis,
          type: 'bar',
          barThickness: 10,
          hidden: true,
