...
import { AuthRolesEnum } from '@ap3/api';
...
export class OrdersController {
  ...
  @ApiOperation({ description: 'Indicates that production is complete and creates an invoice and a nft.' })
  @ApiParam({
    name: 'id',
    type: String,
  ...
  finish(@Request() req: any, @Param('id') id: string): Promise<boolean> {
